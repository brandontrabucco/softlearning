...
class MorphingDKittyUprightEnv(MorphingDKittyEnv):
...
class MorphingDKittyWalk(MorphingDKittyUprightEnv, metaclass=abc.ABCMeta):
...
class MorphingDKittyWalkFixed(MorphingDKittyWalk):
...
@configurable(pickleable=True)
class MorphingDKittyWalkRandom(MorphingDKittyWalk):
...
@configurable(pickleable=True)
class MorphingDKittyWalkRandomDynamics(MorphingDKittyWalkRandom):
    """Walk straight towards a random location."""
